...
class AccessibilityComponentsTest < Minitest::Test
  ROLES = {
    ...
    RadioGroup: :radiogroup, SegmentedControl: :radiogroup, Alert: :alert,
    Switch: :switch, Slider: :slider, RangeSlider: :slider,
    ProgressBar: :progressbar, Spinner: :progressbar, Meter: :meter, Tooltip: :tooltip,
    Popover: :group, HoverCard: :dialog, ContextMenu: :menu, Menu: :menu, MenuBar: :menubar, Dropdown: :button,
    ...
    MultiSelect: :listbox, DatePicker: :combobox, Calendar: :grid, DateRangePicker: :combobox,
    TimePicker: :combobox, ColorPicker: :combobox,
    ...
    SplitPane: :group, PaneGrid: :group, Resizable: :group, DockPanel: :group, DockWorkspace: :group,
    ListView: :list, Table: :table, PropertyGrid: :table,
