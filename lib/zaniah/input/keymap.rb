      ...
      class << self
        ...
        def platform_defaults(platform, **options)
          ...
          map = new(**options)
            ...
            .bind("left", :previous_day, context: "in_calendar")
            .bind("right", :next_day, context: "in_calendar")
            .bind("up", :previous_week, context: "in_calendar")
            .bind("down", :next_week, context: "in_calendar")
            .bind("pageup", :previous_month, context: "in_calendar")
            .bind("pagedown", :next_month, context: "in_calendar")
            .bind("left", :previous_option, context: "in_dock")
            .bind("right", :next_option, context: "in_dock")
            .bind("home", :first, context: "in_dock")
            .bind("end", :last, context: "in_dock")
            .bind("alt-left", :move_previous, context: "in_dock")
            .bind("alt-right", :move_next, context: "in_dock")
            .bind("ctrl-shift-left", :split_left, context: "in_dock")
            .bind("ctrl-shift-right", :split_right, context: "in_dock")
            .bind("ctrl-shift-up", :split_top, context: "in_dock")
            .bind("ctrl-shift-down", :split_bottom, context: "in_dock")
            .bind("ctrl-shift-d", :detach, context: "in_dock")
            .bind("+", :zoom_in, context: "in_zoom_pan && !in_text_field")
            .bind("shift-=", :zoom_in, context: "in_zoom_pan && !in_text_field")
            .bind("-", :zoom_out, context: "in_zoom_pan && !in_text_field")
            .bind("0", :zoom_reset, context: "in_zoom_pan && !in_text_field")
